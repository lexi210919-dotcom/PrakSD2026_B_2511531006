...
public class BubbleSortGUI_1006 extends JFrame {
    ...
    private void setArrayFromInput() {
        ...
        labelArray_1006 =
                new JLabel[array_1006.length];

        for (int k_1006 = 0;
             k_1006 < array_1006.length;
             k_1006++) {

            labelArray_1006[k_1006] =
                    new JLabel(
                            String.valueOf(
                                    array_1006[k_1006]));

            labelArray_1006[k_1006].setFont(
                    new Font(
                            "Arial",
                            Font.BOLD,
                            24));
            ...
            labelArray_1006[k_1006].setBackground(
                    Color.WHITE);

            labelArray_1006[k_1006].setBorder(
                    BorderFactory.createLineBorder(
                            Color.BLACK));

            labelArray_1006[k_1006].setPreferredSize(
                    new Dimension(50, 50));

            labelArray_1006[k_1006].setHorizontalAlignment(
    ...
    private void performStep() {
        ...
        StringBuilder stepLog_1006 =
                new StringBuilder();

        labelArray_1006[j_1006]
                .setBackground(Color.CYAN);

        labelArray_1006[j_1006 + 1]
                .setBackground(Color.CYAN);

        if (array_1006[j_1006]
                > array_1006[j_1006 + 1]) {
        ...
        stepLog_1006.append("Hasil : ")
                .append(arrayToString(array_1006))
                .append("\n\n");

        stepArea_1006.append(
                stepLog_1006.toString());
    ...
    private void resetHighlights() {
        ...
        for (JLabel label_1006
                : labelArray_1006) {

            label_1006.setBackground(
                    Color.WHITE);
        }
    }
    ...
    private String arrayToString(
        ...
        StringBuilder sb_1006 =
                new StringBuilder();

        for (int k_1006 = 0;
             k_1006 < arr_1006.length;
             k_1006++) {
